...
$configuration['setup_password'] = 'quoter33&';
...
$configuration['db']	= 'quoter'; 		//	database name
$configuration['host']	= 'localhost';	//	database host
$configuration['user']	= 'quoter';		//	database user
$configuration['pass']	= 'yourpassword';		//	database password
...
//plugin settings
$configuration['plugins_path'] = $_SERVER['DOCUMENT_ROOT'] . '/quoter/plugins';  //absolute path to plugins folder, e.g c:/mycode/test/plugins or /home/phpobj/public_html/plugins
